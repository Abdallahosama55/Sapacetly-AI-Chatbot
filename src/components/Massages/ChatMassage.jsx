    ...
    <div
      ...
      {useList.map((userChat, index) => (
        <React.Fragment key={index}>
          {/* User Chat */}
          <div
            className="d-flex py-4 pe-md-5 ar align-items-start w-100  justify-content-start"
            dir="rtl">
            <div className=" ">
              <img
                src={image1}
            ...
            <div className=" pe-3">
              ...
              <p className=" fw-light  content-massage  ">{userChat.content}</p>
              <div>
          ...
          {/* Robot Chat */}
          <div
            className="d-flex  pe-md-5  ar justify-content-start align-items-start"
            dir="rtl">
            <div className=" ">
              <img
                src={image2}
            ...
            <div className="ar me-3">
              <div>
                ...
                <p className=" fw-light w-100 ">{robotList[index].content}</p>
                <div>
                  <CopyToClipboard
