      ...
      <div>
        <Form className='justify-content-center align-items-center m-3'>
          <Form.Group className="mb-3">
            ...
            <Form.Select id="disabledSelect" className='p-md-2 text-center bg-light' dir='rtl'>
          ...
          <Form.Group className="mb-3" dir="rtl">
            ...
            <Form.Select id="disabledSelect" className='p-md-2 text-center bg-light'>
          ...
          <Form.Group className="mb-3" dir="rtl">
            ...
            <Form.Control as="textarea" rows={3} id="exampleTextarea" className=' p-md-2 bg-light ' />
          </Form.Group>
