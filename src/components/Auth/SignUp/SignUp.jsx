...
const SignUp = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    email: Yup.string().email("البريد الإلكتروني غير صحيح").required("يرجى إدخال بريدك الإلكتروني"),
          ...
          <Form>
            ...
            <section className="d-flex ar">
              <div className="d-flex flex-column justify-content-center  align-items-center  col-xl-4 col-lg-6 col-12 h_vh_UP">
                ...
                />
                <h1
                  className="color_pink fw-bolder py-2"
                ...
                <div className="d-flex flex-column gap-1 align-content-end w-100 px-5  gap-2">
                  ...
                  <label
                    htmlFor="password"
                    className=" fw-bold  primary fs_auth"
                  >
                    كلمة المرور
                  </label>
                  <Field
                ...
                <p className="fs-5 fw-normal my-2 fs_auth">
                  أو إنشاء حساب بستخدام
                </p>
                <div className="d-flex flex-column gap-3 align-content-end w-100 px-5  gap-2">
                  ...
                  <button className="button_auth fs_auth text-white">
                    إنشاء بواسطة أبل
                    <LazyLoadImage
                      alt={"hi"}
                      effect="blur"
